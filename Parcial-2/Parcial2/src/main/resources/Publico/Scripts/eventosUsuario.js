(() => {
    console.log("Cargando eventos usuario...");
    async function cargarEventosUsuario() {

        try {

            const respuesta = await fetch('/Api/obtenerEventosUsuario');
            ...
            mostrarEventosUsuario(eventosDisponibles);
    ...
    async function mostrarEventosUsuario(eventos) {

        const listaEventos = document.getElementById('listaEventosUsuario');
